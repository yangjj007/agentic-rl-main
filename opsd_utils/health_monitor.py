...
ALERT_HARD_TARGET_INVARIANT = "HARD_TARGET_INVARIANT"
...
class TrainingHealthMonitor:
    ...
    def record_routing(self, step: int, fields: dict[str, Any]) -> None:
        ...
        no_hard_sft = _safe_float(fields.get("no_full_hint_hard_sft_enabled")) > 0.5
        legacy_sft = _safe_float(fields.get("legacy_online_sft_rate"))
        full_hint = _safe_float(fields.get("full_hint_hard_target_rate"))
        if no_hard_sft and (legacy_sft > 1e-12 or full_hint > 1e-12):
            self._emit_alert(
                step,
                ALERT_HARD_TARGET_INVARIANT,
                legacy_online_sft_rate=legacy_sft,
                full_hint_hard_target_rate=full_hint,
            )
    ...
    def finish_step(self, step: int) -> dict[str, float]:
        ...
        mapping = {
            ...
            "routing/legacy_online_sft_slot_rate": "legacy_online_sft_slot_rate",
            "routing/legacy_online_sft_route_rate": "legacy_online_sft_route_rate",
            "routing/legacy_online_sft_forced_rate": "legacy_online_sft_forced_rate",
            "routing/legacy_online_sft_rate": "legacy_online_sft_rate",
            "routing/full_hint_hard_target_rate": "full_hint_hard_target_rate",
            ...
            "teacher_probe/agreement_enabled": "teacher_probe_agreement_enabled",
            "teacher_probe/agreement_accepted_rate": "teacher_probe_agreement_accepted_rate",
            "teacher_probe/agreement_rejected_rate": "teacher_probe_agreement_rejected_rate",
            "teacher_probe/agreement_verified_wrong_rate": "teacher_probe_agreement_verified_wrong_rate",
            "teacher_probe/agreement_attempts_per_candidate": "teacher_probe_agreement_attempts_per_candidate",
            ...
            "routing/mixed_group_hard_replay_rate": "mixed_group_hard_replay_rate",
            "routing/mixed_group_all_wrong_skip_rate": "mixed_group_all_wrong_skip_rate",
