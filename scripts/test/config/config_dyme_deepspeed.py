"""
Memory-tuned DyME baseline (dynamic SFT/GRPO, no OPD) with DeepSpeed ZeRO-2.
...
# Keep the separate embedded cold-start off; ordinary DyME SFT fallback remains active.
